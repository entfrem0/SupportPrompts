...
データ更新工程の使用例はこちらで紹介しています。

#### 日付型／日時型データ項目を更新するサンプル

[https://questetra.github.io/SupportPrompts/date_datetime/example/](https://questetra.github.io/SupportPrompts/date_datetime/example/)
